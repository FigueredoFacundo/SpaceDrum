...
public class Partida {
	...
	Enemigo enemigo1 = new Enemigo(new Circulo(new Punto(500, 100), 20), 100, 25, new Angulo(90),
	...
	Enemigo enemigo3 = new Enemigo(new Circulo(new Punto(500, 400), 25), 40, 25, new Angulo(180),
			new Proyectil(new Circulo(new Punto(20, 20), 1), 1,RecursosExternos.laser),RecursosExternos.player);
