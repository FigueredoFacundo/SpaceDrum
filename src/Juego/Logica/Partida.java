...
public class Partida {
	...
	Enemigo enemigo1 = new Enemigo(new Circulo(new Punto(500, -50), 20), 100, 25, new Angulo(110),
			new Proyectil(new Circulo(new Punto(20, 20), 1), -1,RecursosExternos.laserRed),RecursosExternos.enemigo,2.5);
	...
	Enemigo jefe = new Enemigo(new Circulo(new Punto(500, 450), 50), 1000, 40, new Angulo(0),
			...
			new Proyectil(new Circulo(new Punto(20, 20), 1), -1,RecursosExternos.laserRed),RecursosExternos.enemigo4,0.1);
	ventana.iniciar();
