...
public class Mapa {
	...
	public void calcularColisiones() {
		...
		ArrayList<Entidad> eliminar = new ArrayList<Entidad>();
		ArrayList<Entidad> eliminarEntidad = new ArrayList<Entidad>();
	...
	public void cleanObjOutOfScreen() {
		ArrayList<Entidad> eliminacion = new ArrayList<Entidad>();
		for (Proyectil proyectil : proyectilesEnemigos) {
	...
	public boolean estaElObjetoEnPantalla(Entidad e) {
